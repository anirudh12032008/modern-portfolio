    ...
    <div ref={ref}>
      <div>
        <div className="flex items-end pb-3 justify-between">
          <h4 className="font-body font-semibold uppercase text-black/80">
            {children}
          </h4>
          <h3 className="font-body text-3xl font-bold text-dark/90">
            {width}%
          </h3>
        </div>
        <div className="mt-2 h-3 w-full rounded-full bg-lila">
          <motion.div
            ...
            className="h-3 rounded-full bg-dark/95"
          ></motion.div>
        </div>
      </div>
    </div>
