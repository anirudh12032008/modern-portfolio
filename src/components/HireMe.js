    ...
    <div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden">
      <div className="w-48 h-auto flex items-center justify-center relative">
        ...
        <a
          ...
          className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 dark:bg-light dark:text-dark  bg-dark rounded-full text-light shadow-md border border-solid border-dark w-20 h-20 font-semibold hover:dark:bg-dark hover:dark:text-light dark:border-light hover:bg-light hover:text-dark hover:scale-110"
        >
          HireMe
        </a>
      </div>
